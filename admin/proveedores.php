...
$resultado = $conexion->query("select proveedores.*, libros.nombre as libronombre from proveedores
    inner join libros on proveedores.idlibro = libros.idlibro
          ...
          <tbody>
            <tr>
              ...
              ?>
                ...
                <td><?php echo $f['libronombre'] ?></td>
                <td><?php echo $f['inventario'] ?></td>
                <td>
                  <button class = "btn btn-success btn-small btnComprar" 
    ...
    <div class="modal fade" id="modaleliminar" tabindex="-1" role="dialog" aria-labelledby="modaleliminarLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <form action="#" method="POST" enctype="multipart/form-data">
            <div class="modal-header">
              <h5 class="modal-title" id="modaleliminarLabel">Comprar producto</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              ¿Desea comprar mas libros a este proveedor? 
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
              <button type="submit" class="btn btn-success eliminar" data-dismiss="modal">Comprar</button>
            </div>
          </form>
        </div>
      </div>
