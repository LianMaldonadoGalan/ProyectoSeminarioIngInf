          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">Resultados para: <?php echo $_GET['textobuscar']?></h2></div>
                <div class="d-flex">
            ...
            <?php
              ...
              $resultado = $conexion ->query("SELECT * FROM libros where 
              nombre like '%".$_GET['textobuscar']."%' or
              descripcion like '%".$_GET['textobuscar']."%' or
              precio like '%".$_GET['textobuscar']."%' or
              autor like '%".$_GET['textobuscar']."%'
