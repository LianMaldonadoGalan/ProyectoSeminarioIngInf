...
if (isset($_SESSION['carrito'])) {
  if (isset($_GET['id'])) {
    ...
    if ($encontro == true) {
      ...
      $precio = "";
      $imagen = "";
      $res = $conexion->query('select * from libros where idlibro=' . $_GET['id']) or die($conexion->error);
          ...
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-5 mb-2 mb-md-0">
                <a href="cart.php" class="btn btn-outline-primary btn-sm btn-actualizarcarro">Actualizar carrito</a>
              </div>
              <div class="col-md-6">
                <a href="index.php" class="btn btn-outline-primary btn-sm btn-seguir">Seguir comprando</a>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-13">
                    <button class="btn btn-primary btn-lg py-3 btn-block" onclick="window.location='checkout.php'">Proceder con la compra</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".txtCantidad").keyup(function() {
        ...
        var id = $(this).data('id');
        var res = parseFloat(cantidad) * parseFloat(precio);
