      ...
      <div class="row align-items-center">
        ...
        <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
          <form action="./busqueda.php" class="site-block-top-search" method="GET">
            ...
            <input type="text" class="form-control border-0" placeholder="Buscar" name="textobuscar">
          </form>
        </div>
            ...
            <ul>
              <?php
                if(isset($_SESSION['datos_login'])){
                  echo '<li><a href="./admin/pedidos.php"><span class="icon icon-person"></span></a></li>';
                }else{
                  echo '<li><a href="./login.php"><span class="icon icon-person"></span></a></li>';
                }
              ?>
              <!--<li><a href="../admin/libros.php"><span class="icon icon-person"></span></a></li>-->
